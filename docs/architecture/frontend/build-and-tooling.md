...
| Variable | Status |
| --- | --- |
| `VITE_PRIMEUI_LICENSE_KEY` | Read in `main.tsx`. Without it PrimeReact renders an "Invalid PrimeUI License" badge. |
| `VITE_API_BASE_URL` | Declared, not yet read. See [the API seam](state-and-data.md#the-api-seam). |
